...
function LoginPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-800 to-gray-800 px-4">
      ...
      >
        <h2 className="text-3xl font-bold text-cyan-400 mb-6 text-center tracking-wide">Welcome Back 👋</h2>
        ...
        <div className="mb-4 relative">
          ...
          <button
            type="button"
            className="absolute top-8 right-3 text-gray-400 hover:text-cyan-400 transition"
        ...
        {error && (
          <div className="mt-4 text-red-500 text-sm text-center animate-pulse">
            {error}
          </div>
        )}
